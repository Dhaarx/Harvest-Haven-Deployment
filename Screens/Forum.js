...
const Forum = () => {
  ...
  useEffect(() => {
    fetch('https://mongodb-api-harvest-haven.onrender.com/questions')
  ...
  const handleLike = (questionId) => {
    const updatedQuestions = questions.map((question) => {
      if (question._id === questionId) {
        question.likes += 1;
        fetch(`https://mongodb-api-harvest-haven.onrender.com/questions/${questionId}/like`, {
          method: 'PATCH',
        })
    ...
    if (newReply.trim()) {
      const updatedQuestions = questions.map((question) => {
        if (question._id === questionId) {
          ...
          fetch(`https://mongodb-api-harvest-haven.onrender.com/questions/${questionId}/reply`, {
            method: 'PATCH',
            headers: { 'Content-Type': 'application/json' },
