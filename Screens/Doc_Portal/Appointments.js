...
const DoctorAppointments = () => {
  ...
  const fetchAppointmentRequests = async () => {
    try {  
      const response = await fetch('https://mongodb-api-harvest-haven.onrender.com/appointments');
  ...
  const handleConfirm = async (appointmentId) => {
    try {
      await fetch(`https://mongodb-api-harvest-haven.onrender.com/appointments/${appointmentId}`, {
        method: 'PATCH',
        headers: {
